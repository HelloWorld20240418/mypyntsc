...
project.Connect("192.168.18.216", 80)
...
case.Config("NetworkSubnet", {"port3": {"SubnetNumber": 1, "IpAddrRange": "18.1.2.2+100", "Netmask": "16", "ServerIPRange": "18.1.1.2+10"}})

# - For port2: Subnet number 1, IP address range 18.1.1.2, netmask 16 bits
case.Config("NetworkSubnet", {"port4": {"SubnetNumber": 1, "IpAddrRange": "18.1.1.2+10", "Netmask": "16"}})
