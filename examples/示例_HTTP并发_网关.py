...
project.Connect("192.168.15.150", 80)
...
case = project.CreateCase("HttpCc", "Gateway")
...
case.Config("NetworkSubnet", {"port1": {"SubnetNumber": 1, "IpAddrRange": "18.1.2.2+200", "Netmask": "16", "ServerIPRange": "18.1.1.2+10"}})

# - For port2: Subnet number 1, IP address range 18.1.1.2, netmask 16 bits
case.Config("NetworkSubnet", {"port2": {"SubnetNumber": 1, "IpAddrRange": "18.1.1.2+10", "Netmask": "16"}})
